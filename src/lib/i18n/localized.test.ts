...
const LOCALIZED = [
  ...
  "src/components/ChatClearDialog.tsx",
  ...
  "src/components/QuarterCompareTable.tsx",
  "src/components/ErrorDetailModal.tsx",
  "src/components/ScoreCountUp.tsx",
  "src/components/AnalysisFailure.tsx",
  ...
  "src/lib/ui/countUp.ts",
  "src/lib/llm/cost.ts",
  "src/lib/prompts/analysisSteps.ts",
