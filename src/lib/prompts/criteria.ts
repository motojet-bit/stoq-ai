...
export const CRITERIA: Criterion[] = [
  ...
  },
  {
    ...
    label: "売上成長のモメンタム",
    hint:
      "**四半期推移を最優先で見る。** 前年同期比が直近で拡大しているか縮小しているかを明示し、" +
      "加速なら根拠にその数値（例: +12.3% → +16.4%）を書く。減速している場合はスコアを 3 以下にする。" +
      "季節性のある事業では前四半期比を成長判断に使わない。",
  },
  {
    id: 5,
    category: "収益性",
  ...
  },
  {
    ...
    hint:
      "売上増に対して利益がより速く伸びているか。**四半期推移の純利益率が改善しているか悪化しているかを必ず述べる。**" +
      "悪化しているのに売上だけ伸びている場合は、その要因（値引き・コスト増・ミックス悪化）を指摘する。",
  },
  {
    id: 7,
    category: "収益性",
