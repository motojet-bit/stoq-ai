...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::usage_log_append,
            commands::usage_log_list,
            commands::usage_log_clear,
            commands::analysis_step_save,
            commands::analysis_steps_load,
            commands::analysis_steps_clear,
